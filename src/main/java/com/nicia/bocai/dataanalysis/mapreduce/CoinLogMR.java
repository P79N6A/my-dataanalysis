...
public class CoinLogMR {
    ...
    private static final int WECHATE_TOP_UP_GAME_ID = -10;
    ...
    public static class TokenizerMapper extends MapperBase {
        ...
        public void map(long recordNum, Record __record, TaskContext context) throws IOException {
            ...
            double rmb_change_double = __record.getDouble("rmb_change_double");
            ...
            if (command.equals("米大师订单") || command.equals("微信公众号订单")) {
                ...
                game_id = command.equals("微信公众号订单") ? WECHATE_TOP_UP_GAME_ID : game_id;
            }

            if (pay_first == 1){
                first_money = cash_in_double;
            }
            ...
            __valueOut.set("first_money", first_money);
    ...
    public static class SumCombiner extends ReducerBase {
        ...
        public void reduce(Record __record, Iterator<Record> __values, TaskContext context) throws IOException {
            ...
            long pay_first = 0;
            long action_time = 0;
            double first_money = 0;

            while (__values.hasNext()) {
                Record __v = __values.next();
                rmb_change_double +=  __v.getDouble("rmb_change_double");
                cash_in_double +=  __v.getDouble("cash_in_double");
                cash_out_double +=  __v.getDouble("cash_out_double");
                ...
                first_money = Math.max(__v.getDouble("first_money"), first_money);
            }
