...
//            throw new IOException("map 执行无误");
        }
    }
...
//            throw new IOException("combine 执行无误");
        }
    }
...
//        if (true) {
//            throw new OdpsException("args[1] = " + args[1] + ", logDate = " + logDate);
//        }
//        System.out.println(OutputUtils.getTables(log.getJob())[0].getPartitionSpec().toString());
//        System.out.println(BaseLog.resolveLogDate(OutputUtils.getTables(log.getJob())[0].getPartitionSpec().toString()));
        log.run();
    }
